...
float FusionCompassCalculateHeading(const FusionVector3 accelerometer, const FusionVector3 magnetometer) {
    ...
    // Itt összeadás kell a compass tutorialban lévő szenzor-orientáció miattt (compass_tutorial02.c:74)
    const FusionVector3 magneticNorth = FusionVectorFastNormalise(FusionVectorCrossProduct2(magneticWest, accelerometer));
